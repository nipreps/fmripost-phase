...
1. wget https://raw.githubusercontent.com/nipreps/fmriprep-phase/main/scripts/fetch_templates.py
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Helper script for pre-caching required templates to run fMRIPost-Phase',
    )
    parser.add_argument(
        '--tf-dir',
