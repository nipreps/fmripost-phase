...
#
"""Workflows for resampling images."""
...
def init_bold_volumetric_resample_wf(
    *,
    ...
    fields : list
        Additional images to be resampled alongside the BOLD series.
    omp_nthreads
    ...
    outputnode = pe.Node(
        niu.IdentityInterface(fields=['bold_file', 'resampling_reference'] + fields),
        name='outputnode',
    )
