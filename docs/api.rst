...
---------------------------------------------------
*fMRIPost-Phase* is a *NiPreps* application, and abides by the
...
---------------------------------------
We believe that *fMRIPost-Phase* must be free to use, inspect, and critique.
...
.. automodule:: fmripost_phase.config
   :members: from_dict, load, get, dumps, to_filename, init_spaces

Workflows
---------

.. automodule:: fmripost_phase.workflows.base
.. automodule:: fmripost_phase.workflows.phase
