...
Installation
------------
*fMRIPost-Phase* should be installed using container technologies.

.. code-block:: bash
  docker pull nipreps/fmripost-phase:main


Containerized execution (Docker and Singularity)
================================================
*fMRIPost-Phase* is a *NiPreps* application, and therefore follows some overarching principles
...
---------------------
*fMRIPost-Phase* is written using Python 3.8 (or above), and is based on
nipype_.

*fMRIPost-Phase* requires some other neuroimaging software tools that are
...
===============================================
If you intend to run *fMRIPost-Phase* on a remote system, you will need to
