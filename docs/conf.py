# fmripost_phase documentation build configuration file, created by
...
project = 'fMRIPost-Phase'
author = 'The fMRIPost-Phase developers'
...
# html_title = u'fmripost_phase vversion'
...
latex_documents = [
    (master_doc, 'fmripost_phase.tex', 'fMRIPost-Phase Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'fmripost-phase', 'fMRIPost-Phase Documentation', [author], 1)]
...
linkcode_resolve = make_linkcode_resolve(
    'fmripost_phase',
    'https://github.com/nipreps/fMRIPost-Phase/blob/{revision}/{package}/{path}#L{lineno}',
)
